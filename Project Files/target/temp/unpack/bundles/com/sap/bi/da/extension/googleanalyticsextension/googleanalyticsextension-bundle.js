...
define([], function() {
    return sap.bi.framework.declareBundle({
        ...
        "version" : "1.25.3.201611031253",
         "components" : [{
            "id" : "com.sap.bi.da.extension.googleanalyticsextension",
            "provide" : "sap.bi.da.extension.client",
            "module" : "GoogleAnalyticsExtension",
            "customProperties" : {
                "displayName" : "Google Analytics and YouTube Analytics",
                "description" : "Connect to Google Analytics and YouTube"
            }
        }],
